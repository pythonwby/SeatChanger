...
class Ui_Dialog_Set_Seat(object):
    ...
    def update_seat_list(self,Dialog):
        ...
        if flag:
            QtWidgets.QMessageBox.critical(Dialog,"错误","输入的SeatList有误",QtWidgets.QMessageBox.StandardButton.Ok)
        elif flag1:
            QtWidgets.QMessageBox.critical(Dialog,"错误","输入的StartTime有误",QtWidgets.QMessageBox.StandardButton.Ok)
        else:
            global Flag_Cancel
            Flag_Cancel = False
            Dialog.close()
