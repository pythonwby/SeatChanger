...
class SeatImageClass:
    SeatList = [[8, 47, 7, 22, 6, 10, 23, 37, 14, 5, 27, 46, 12, 51, 39, 15, 49, 3, 2, 18, 50, 43, 41, 19, 1],
                # 靠左列，第五组靠后
                [9, 40, 29, 30, 48, 25, 34, 31, 36, 33, 16, 45, 11, 35, 28, 32, 21, 13, 24, 38, 20, 4, 42, 17,
                 26]]  # 靠右列，第五组靠前
...
class Ui_Dialog_About(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "座位计算器 By 乌搏猿 2024.3.31"))
        self.textEdit.setText('''Python 3.12.2
