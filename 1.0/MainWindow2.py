...
class SeatImageClass:
    ...
    def ListToImage(self):
        for i in range(1, 7):
            SeatImage[6][i] = self.SeatList[1][i - 1]
            SeatImage[5][i] = self.SeatList[0][i - 1]
        for i in range(0, 8):
            SeatImage[4][i] = self.SeatList[1][i + 6]
            SeatImage[3][i] = self.SeatList[0][i + 6]
        for i in range(0, 4):
            SeatImage[2][i * 2 + 1] = self.SeatList[0][i + 14]
            SeatImage[2][i * 2] = self.SeatList[1][i + 14]
        for i in range(0, 7):
            SeatImage[1][i + 1] = self.SeatList[1][i + 18]
            SeatImage[0][i + 1] = self.SeatList[0][i + 18]
    ...
    def update_table_widget(self,flag):  # 更新表格，flag=True，下一周
        ...
        for i in range(7):
            for j in range(8):
                ...
                # testitem.setText('a')
                # testitem.setTextAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
                # self.tableWidget.setItem(i,j,testitem)
                tempitem=QtWidgets.QTableWidgetItem()
                tempitem.setText(NumberToName[SeatImage[i][j]])
...
# Test SeatImage1 class
# SeatImage1=SeatImageClass()
# SeatImage1.ListToImage()
# SeatImage1.PrintImage()
# SeatImage1.NextWeek()
# SeatImage1.ListToImage()
# SeatImage1.PrintImage()
# SeatImage1.NextWeek()
